...
<body>
    ...
    <section class="registration-done">
        <div class="message-container">
            <div class="content">
                <img class="img-registration" src="assets/img/report.png" alt="">
                <h3 class="text-danger">Erreur d'activation</h3>
                <p>L'activation de compte a échoué, veuillez réessayer</p>
            </div>
        </div>
    </section>
