<div class="modal fade addPatient" wire:ignore.self tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
            ...
            <div class="modal-body bg-white">
                <form wire:submit.prevent="save" class="row g-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="inputPassword" wire:model="add_birthday">
                        <span class="text-danger">
                            @error('add_birthday')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputPassword" placeholder="Saisir la ville"
                            wire:model="add_city">
                        <span class="text-danger">
                            @error('add_city')
                                {{ $message }}
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary mt-3">Ajouter Patient</button>
                    </div>
                </form>
            </div>
        </div>
