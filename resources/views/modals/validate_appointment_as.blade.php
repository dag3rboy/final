<div class="modal fade validateAppointmentAS" wire:ignore.self tabindex="-1" aria-labelledby="exampleModalLabel"
...
{{-- 
                    <div class="col-md-6">
                        <button wire:click="validateAppointment('{{$ap_id}}')" value="valide"
                            class="btn btn-success w-100 mt-3">Valider</button>
                    </div> --}}
