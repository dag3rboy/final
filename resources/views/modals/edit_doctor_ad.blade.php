<div class="modal fade editDoctor" wire:ignore.self tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg modal-dialog-centred">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Modifier médecin</h5>
            ...
            <div class="modal-body bg-white">
                <form wire:submit.prevent="update" class="row g-2">
                    ...
                    <div class="col-md-5">
                        ...
                        <select class="form-control" wire:model="edit_speciality">
                            ...
                            <option value='Chirurgien esthétique et plastique'>Chirurgien esthétique et plastique
                            </option>
                            ...
                            <option value='Maladies et Chirurgie CardioVasculaire'>Maladies et Chirurgie
                                CardioVasculaire</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="firstName" placeholder="Saisir le department"
                            wire:model="edit_department">
                        <span class="text-danger">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputLastName" placeholder="Saisir le service"
                            wire:model="edit_service">
                        <span class="text-danger">
                            @error('edit_service')
                                {{ $message }}
                            @enderror
