...
<body>
    ...
    <section class="registration-done">
        <div class="message-container">
            <div class="content">
                <img class="img-registration" src="assets/img/schedule.png" alt="">
                <h3>Rendez-vous effectuée avec succès</h3>
                <p>Vous recevrez une notification lorsque votre rendez-vous sera validé par le médecin</p>
